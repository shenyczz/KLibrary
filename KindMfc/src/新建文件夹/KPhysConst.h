...
namespace Math
{
	...
	class KIND_EXT_CLASS CPhysConst  
	{
	public:
		CPhysConst();
		virtual ~CPhysConst();
	...
	public:
		...
		BOOL IsPhysConst(LPCTSTR str);
		//double GetPhysConstValue(const CString str);
		double GetPhysConstValue(const LPCTSTR str);
		LPCTSTR GetEachPhysConst(int i);

	private:
		// String Array
		//CStringArray m_strPhysConst;
		//TCollection<KString> m_strPhysConst;
		KStringArray m_strPhysConst;
