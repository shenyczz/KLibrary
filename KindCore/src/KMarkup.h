...
public:
	enum MarkupDocFlags
	{
		MDF_UTF16LEFILE = 1,			// 0x01
		MDF_UTF8PREAMBLE = 4,			// 0x04
		MDF_IGNORECASE = 8,				// 0x08
		MDF_READFILE = 16,				// 0x10
		MDF_WRITEFILE = 32,				// 0x20
		MDF_APPENDFILE = 64,			// 0x40
		MDF_UTF16BEFILE = 128,			// 0x80
		MDF_TRIMWHITESPACE = 256,		// 0x100
		MDF_COLLAPSEWHITESPACE = 512	// 0x200
	};
...
public:
	...
	// 设置文档（pDoc is markup text, not a filename）
